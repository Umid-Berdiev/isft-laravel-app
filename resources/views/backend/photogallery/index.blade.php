...
<div class="row">
    <div class="col-12">
        <div class="card-box table-responsive">
            <div class="row m-0">
                <div class="col-sm-6">
                    <h4 class="m-t-0 m-b-30 header-title">Фотогалерея</h4>            
                </div>
                <div class="col-sm-6">
...
<script>    
    var crud = new Crud({
        filter: true,
        form: {
            url: "{{ route('backend.photogallery.form') }}",
        },
        list: {
            url: "{{ route('backend.photogallery.data') }}",
            datatable: {            
                columns: [
                    {data: 'id', name: 'id'},
        ...
        remove: {
            url: "{{ route('backend.photogallery.delete') }}",
        }
    });
</script>
@endsection